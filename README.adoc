...
Step 2: set up a remote nrepl server. I use cursive in intellij. The host is localhost, port is 900, context module is fulcro app. 

Terminal 3:  -A:dev -J-Dtrace -J-Dghostwheel.enabled=true (maybe remove the last part?) 
