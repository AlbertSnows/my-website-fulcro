...
(def node-options
  {:first
   {:image/id  "end-node"
    ...
    :image/src (image-url "end-node.PNG")}
   :middle
   {:image/id  "middle-node"
    :image/alt "arbitrary point in timeline"
    :image/src (image-url "middle-node.png")}
   :end
   {:image/id  "end-of-the-road"
    :image/alt "end of the node, cowboy"
    :image/src (image-url "end-of-the-road.png")}})

(def left-arrow
  {:image/id  "LPR"
   :image/alt "left, point right"
   :image/src (image-url "left-side-arrow.png")})
(def right-arrow
  {:image/id  "RPL"
   :image/alt "right, point left"
   :image/src (image-url "right-side-arrow.png")})
...
(def hrefs
  {159 ["how-now-brown-cow"
   ...
   151 ["shlist"
        ...
        (image-url "sh_list.webp")
        "shindler's list"]
   150 ["prisoners"
        "https://youtu.be/fekd6LcnSyw"
        (image-url "prisoners.webp")
        "prisoners"]
   149 ["gf"
        "https://youtu.be/9qK2Nzsvik0"
        (image-url "g_fireflies.jpg")
        "grave of fireflies"]
   148 ["ug"
        "https://youtu.be/7GYmbBH6YT4"
        (image-url "uncutgems.PNG")
        "uncut gems"]
   147 ["tuat"
        "https://youtu.be/finxyQqDrP0"
        (image-url "evangelion_final.jpeg")
   ...
   137 ["ruiner"
        ...
        (image-url "ruiner.png")
        "ruiner"]
   136 ["cmiygl"
        "https://youtu.be/qz-k3DoMxkw"
        (image-url "ttccmiygl.webp")
        "call me if you get lost"]
   135 ["haooot"
        "https://youtu.be/DCkJ5lGPqFs"
        (image-url "haooot.jpg")
        "hall and oates"]
   134 ["mbs"
   ...
   128 ["bp"
        ...
        (image-url "bottomless_pit.jpg")
        "bottomless pit"]
   127 ["bost"
        "https://youtu.be/Due9qiZ2t5w"
        (image-url "brigador.jpg")
        "brigador ost" ]
   126 ["ibr"
        "https://youtu.be/LZgLipTxWL8"
        (image-url "recharge.jpg")
        "ibrahim" ]
   125 ["mc"
        "https://youtu.be/B_ymY0xG0LI"
        (image-url "moonchild.jpg")
        "moonchild" ]
   124 ["pup"
        "https://youtu.be/8L0XuwPzmgU"
        (image-url "Pup_MorbidStuff.webp")
        "pup"]
   123 ["op"
        "https://youtu.be/E4nJoiAynjI"
        (image-url "u_wot_m8.png")
        "Oyasumi_Punpun"]
   122 ["llhst"
   ...
   121 ["cthg"
        ...
        (image-url "crouching-tiger-hidden-sun.jpg")
        "Crouching Tiger Hidden Gabber"]
   120 ["wolf-girl"
        "https://youtu.be/3R2XGxbpPNs"
        (image-url "wolf-girl.jpg")
        "wlfgrl"]
   119 ["DOS2"
   ...
   116 ["tptb"
        ...
        (image-url "the-powers-that-b.jpg")
        "Inanimate Sensation"]
   115 ["syn"
        "https://youtu.be/j1LZ9EOMqsY"
        (image-url "synecdoche.jpg")
   ...
   113 ["td"
        ...
        (image-url "taxidriver.jpg")
        "You talkin to me?"]
   112 ["lh"
        "https://www.youtube.com/watch?v=WBZwUdJFnhw"
        (image-url "lighthouse.jpg")
   ...
   100 ["gits-show"
        ...
        (image-url "GITSSAC.jpg")
        "Stand Alone Compex"]
   99  ["gits-ost-1"
        "https://youtu.be/mfUpn6pJFrs"
        (image-url "GITSSACOST2-1.jpg")
        "OST1"]
   98  ["gits-ost-2"
        "https://youtu.be/lWhM_x_g6p4"
        (image-url "GITSSACOST1.webp")
        "OST2"]
   97  ["gits-ost-3"
        "https://youtu.be/YtqMOKuUNHs"
        (image-url "GITSSACOST2.webp")
        "OST3"]
   96  ["charlie"
   ...
   80  ["street-epist"
        ...
        (image-url "street-epist.jpg")
        "Ask The Right Questions"]
   79  ["potholer"
        "https://youtu.be/EhWpP-vPUcQ"
        (image-url "potholer54.jpg")
        "Quackery!"]
   78  ["phil-overdose"
        "https://youtu.be/wY9Xm5xgiEE"
        (image-url "philoverdose.jpg")
        "Thanks grandpa"]
   77  ["phil-tube"
        "https://youtu.be/wO6uD3c2qMo"
        (image-url "philtube.jpg")
        "Phil tube"]
   76  ["k-uchis-c"
   ...
   61  ["john-stewart"
        ...
        (image-url "john-stewart.jpg")
        "John Stewart"]
   60  ["exurb1a"
        "https://youtu.be/lstXHHlLrKo"
        (image-url "exurb1a.jpg")
        "you twat"]
   59  ["blu-swing-r"
   ...
   58  ["bunny-hop"
        "https://youtu.be/N_-jyF987MQ"
        (image-url "bunnyhop.jpg")
        "bunny hop"]
   57  ["adam-conover"
        "https://youtu.be/q4pV8cKXKnU"
        (image-url "adam-conover.jpg")
        "ARE"]
   56  ["metro"
   ...
   36  ["vsauce"
        ...
        (image-url "vsauce.jpg")
        "Hey, Vsauce! Michael here."]
   35  ["total-buscuit"
        "https://youtu.be/k69PbHoSWm4"
        (image-url "total-biscuit.jpg")
        "See you next time..."]
   34  ["game-theory"
   ...
   30  ["black-parade"
        ...
        (image-url "MCRTBP.jpg")
        "would you be, savoir of the broken?"]
   29  ["ff13-ost"
        "https://youtu.be/SnvzYXtdeTo"
        (image-url "FF13OST1.jpg")
        "overrrrrrrrrrrr"]
   28  ["cgp-grey"
        "https://youtu.be/s7tWHJfhiyo"
        (image-url "cgp-grey.jpg")
